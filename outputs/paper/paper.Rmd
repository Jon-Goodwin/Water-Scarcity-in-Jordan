...
# Data
  ...
  The survey covers 7600 households, the sample is nationally represenative, the intent of the survey was to provide information on levels of fertility, infant and child mortality and family planning. Of this survey, this analysis is focused on the information regarding the source of water and the time availability of water. This information was available in the JPFHS report on page 32, table 2.7.
  
  To compile the data set, the R language was used, [@citeR], along with the packages, Pointblank [citePointblank], haven [citehaven], the paper [@citeknitr]
...
More information regarding the availability deficiencies would be the next steps. Are the rural areas receiving water via tanker truck completely remote or can they receive piped water sources?
